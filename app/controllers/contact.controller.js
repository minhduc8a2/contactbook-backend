...
exports.update = async (req, res, next) => {
  ...
  try {
    const contactService = new ContactService(MongoDB.client)
    let document = await contactService.update(req.params.id, req.body)
...
exports.delete = async (req, res, next) => {
  try {
    ...
    let document = await contactService.delete(req.params.id)
...
exports.deleteAll = async (req, res, next) => {
  try {
    ...
    let deletedCount = await contactService.deleteAll()
    return res.send({
